...
# MAGIC %md
# MAGIC #### Calling the Logger Notebook
...
# MAGIC %md
# MAGIC #### Calling the utilities notebook
...
# MAGIC %md
# MAGIC #### Calling the configuration notebook
...
df_final_FA = spark.sql("select * from default.financial_account_holder where CurrentRecord='Yes' ")
...
# MAGIC %sql
# MAGIC Select count(1), FinancialAccountNumber from silver.financial_account where CurrentRecord='Yes'
...
# MAGIC %sql
# MAGIC select FinancialAccountNumber,DW_Modified_Date,End_Date,* from silver.financial_account where FinancialAccountNumber='13-CD-00000000000000010606'
